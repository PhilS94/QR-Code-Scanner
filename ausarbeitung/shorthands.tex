...
%-- Computer Vision abkuerzungen
\DeclareRobustCommand{\OpenCV}{\emph{OpenCV}\xspace}
\DeclareRobustCommand{\QRCode}{QR-Code\xspace}
\DeclareRobustCommand{\QRCodes}{QR-Codes\xspace}

%-- Häufig verwendete Namen die einheitlich sein sollten.
\DeclareRobustCommand{\fp}{Finder Pattern\xspace}
\DeclareRobustCommand{\fps}{Finder Patterns\xspace}

\DeclareRobustCommand{\olfp}{obere linke Finder Pattern\xspace}
\DeclareRobustCommand{\orfp}{obere rechte Finder Pattern\xspace}
\DeclareRobustCommand{\ulfp}{untere linke Finder Pattern\xspace}
\DeclareRobustCommand{\olfps}{oberen linken Finder Patterns\xspace}
\DeclareRobustCommand{\orfps}{oberen rechten Finder Patterns\xspace}
\DeclareRobustCommand{\ulfps}{unteren linken Finder Patterns\xspace}
\DeclareRobustCommand{\olfpn}{oberen linken Finder Pattern\xspace}
\DeclareRobustCommand{\orfpn}{oberen rechten Finder Pattern\xspace}
\DeclareRobustCommand{\ulfpn}{unteren linken Finder Pattern\xspace}
